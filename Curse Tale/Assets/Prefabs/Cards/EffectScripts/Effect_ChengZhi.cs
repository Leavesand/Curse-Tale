...
public class Effect_ChengZhi : MonoBehaviour
{
    // 祝符效果：诚挚
    ...
    void Start()
    {
        ...
        description.GetComponent<Text>().text = "提升中邪者祝福" + value + "点。";
    ...
    private void OnMouseEnter()
    {
        if (isLoaded)
        {
            ...
            floatingDescription.GetComponent<Text>().text = "提升中邪者祝福" + value * thisCardLoad.cardLevel + "点。";
        }
        else
        {
