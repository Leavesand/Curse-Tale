...
public class Effect_AnFu : MonoBehaviour
{
    // 祝符效果：安抚
    ...
    void Start()
    {
        ...
        description.GetComponent<Text>().text = "回复中邪者精神" + value + "点。";
    ...
    void Update()
    {
        ...
        {
            // 卡牌发动效果
            thePatient.GetComponent<PatientController>().IncreaseSanity(value);
    ...
    private void OnMouseEnter()
    {
        if (isLoaded)
        {
            ...
            floatingDescription.GetComponent<Text>().text = "回复中邪者精神" + value * thisCardLoad.cardLevel + "点。";
        }
        else
        {
